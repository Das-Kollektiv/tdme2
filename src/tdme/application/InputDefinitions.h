#pragma once
	...
	#define KEYBOARD_KEYCODE_LEFT_CTRL -2
	#define KEYBOARD_KEYCODE_LEFT_ALT -3
	#define KEYBOARD_KEYCODE_RIGHT_SHIFT -4
	#define KEYBOARD_KEYCODE_RIGHT_CTRL -5
	#define KEYBOARD_KEYCODE_RIGHT_ALT -6
