#pragma once
	...
	#define KEYBOARD_KEYCODE_LEFT_SHIFT -1
	#define KEYBOARD_KEYCODE_LEFT_CTRL -1
	#define KEYBOARD_KEYCODE_LEFT_ALT -1
	#define KEYBOARD_KEYCODE_RIGHT_SHIFT -1
	#define KEYBOARD_KEYCODE_RIGHT_CTRL -1
	#define KEYBOARD_KEYCODE_RIGHT_ALT -1
