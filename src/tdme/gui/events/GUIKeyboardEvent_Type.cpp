...
GUIKeyboardEvent_Type* tdme::gui::events::GUIKeyboardEvent_Type::KEYBOARDEVENT_KEY = new GUIKeyboardEvent_Type("KEY", 3);
...
GUIKeyboardEvent_Type* GUIKeyboardEvent_Type::valueOf(const string& a0)
{
	...
	if (KEYBOARDEVENT_KEY->getName() == a0) return KEYBOARDEVENT_KEY;
