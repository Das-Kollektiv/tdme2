...
GUITabs::GUITabs()  /* throws(IOException) */
...
void GUITabs::ctor() /* throws(IOException) */
{
	super::ctor();
	attributes = new _HashMap();
	template_ = _FileSystem::getInstance()->getContent(u"resources/gui/definitions/elements"_j, u"tabs.xml"_j);
}
