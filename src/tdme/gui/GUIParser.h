...
public:
	 ...
	 * @throws tdme::os::filesystem::FileSystemException
	 */
	static GUIScreenNode* parse(const string& pathName, const string& fileName, const unordered_map<string, string>& variables = {}, const TDMEMiniScript::ScriptVariable& miniScriptArguments = TDMEMiniScript::ScriptVariable(), Context* context = nullptr);
	 ...
	 * @throws tdme::os::filesystem::FileSystemException
	 */
	static GUIScreenNode* parse(const string& xml, const unordered_map<string, string>& variables = {}, const string& pathName = string(), const string& fileName = string(), const TDMEMiniScript::ScriptVariable& miniScriptArguments = TDMEMiniScript::ScriptVariable(), Context* context = nullptr);
