...
public:
	GUIHorizontalScrollbarInternalController_State(::java::lang::String* name, int ordinal);
protected:
...
public:
	...
	static GUIHorizontalScrollbarInternalController_State* valueOf(String* a0);
