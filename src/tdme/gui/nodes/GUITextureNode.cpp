...
bool GUITextureNode::isContentNode()
{
	return true;
}

int GUITextureNode::getContentWidth()
{
...
int GUITextureNode::getContentHeight()
{
...
void GUITextureNode::render(GUIRenderer* guiRenderer)
{
...
void GUITextureNode::setTextureMatrix(const Matrix2D3x3& textureMatrix) {
	this->textureMatrix.set(textureMatrix);
}

const GUIColor& GUITextureNode::getEffectColorMul() {
	return effectColorMul;
}

void GUITextureNode::setEffectColorMul(const GUIColor& effectColorMul) {
	this->effectColorMul = effectColorMul;
}

const GUIColor& GUITextureNode::getEffectColorAdd() {
	return effectColorAdd;
}

void GUITextureNode::setEffectColorAdd(const GUIColor& effectColorAdd) {
	this->effectColorAdd = effectColorAdd;
}

GUINode_Clipping& GUITextureNode::getClipping() {
	return clipping;
}

GUINode_Clipping GUITextureNode::createClipping(const string& allClipping, const string& left, const string& top, const string& right, const string& bottom)
{
...
const string& GUITextureNode::getMask() {
	return mask;
}

void GUITextureNode::setMask(const string& mask) {
