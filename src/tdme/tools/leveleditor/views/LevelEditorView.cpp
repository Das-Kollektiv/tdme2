...
{
	auto groundPlate = new Model("leveleditor.ground", "leveleditor.ground", Model_UpVector::Y_UP, RotationOrder::XYZ, new BoundingBox(Vector3(0.0f, -0.01f, 0.0f), Vector3(1.0f, +0.01f, 1.0f)));
