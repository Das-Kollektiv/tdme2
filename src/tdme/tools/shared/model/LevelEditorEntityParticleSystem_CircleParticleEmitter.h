 ...
 * @version $Id$
 */
class tdme::tools::shared::model::LevelEditorEntityParticleSystem_CircleParticleEmitter
...
protected:
	LevelEditorEntityParticleSystem_CircleParticleEmitter(const ::default_init_tag&);
