...
class tdme::tools::shared::controller::ParticleSystemScreenController_onActionPerformed_4
...
public:
	...
	// Generated
	ParticleSystemScreenController_onActionPerformed_4(ParticleSystemScreenController *ParticleSystemScreenController_this);
