		...
		case GIZMOTYPE_ALL:
			{
				...
				auto gizmoCount = 0;
				if ((gizmoTypeMask & GIZMOTYPE_TRANSLATE) == GIZMOTYPE_TRANSLATE) gizmoCount++;
				if ((gizmoTypeMask & GIZMOTYPE_ROTATE) == GIZMOTYPE_ROTATE) gizmoCount++;
				if ((gizmoTypeMask & GIZMOTYPE_SCALE) == GIZMOTYPE_SCALE) gizmoCount++;
				if (gizmoCount  == 3) {
