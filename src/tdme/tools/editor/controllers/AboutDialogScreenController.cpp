...
void AboutDialogScreenController::initialize()
{
	try {
		...
		required_dynamic_cast<GUIMultilineTextNode*>(screenNode->getNodeById("about_graphics"))->setText(MutableString("Graphics: " + StringTools::replace(StringTools::replace(Engine::getInstance()->getGraphicsRenderer(), "AMD", "[font=resources/engine/fonts/Roboto_bold_30.fnt]AMD[/font]"), "DRM", "[font=resources/engine/fonts/Roboto_bold_20.fnt]DRM[/font]")));
