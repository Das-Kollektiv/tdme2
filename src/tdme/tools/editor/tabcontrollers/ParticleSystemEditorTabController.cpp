				...
				if (bbpe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_box_colorstart"))->setEffectColorMul(bbpe->getColorStart().getArray());
							} catch (Exception& exception) {
				...
				if (bbpe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_box_colorend"))->setEffectColorMul(bbpe->getColorEnd().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (ppe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_point_colorstart"))->setEffectColorMul(ppe->getColorStart().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (ppe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_point_colorend"))->setEffectColorMul(ppe->getColorEnd().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (spe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_sphere_colorstart"))->setEffectColorMul(spe->getColorStart().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (spe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_sphere_colorend"))->setEffectColorMul(spe->getColorEnd().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (cpe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_circle_colorstart"))->setEffectColorMul(cpe->getColorStart().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (cpe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_circle_colorend"))->setEffectColorMul(cpe->getColorEnd().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (rpe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_radial_colorstart"))->setEffectColorMul(rpe->getColorStart().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
				...
				if (rpe != nullptr) {
					...
					public:
						void performAction() override {
							...
							//
							try {
								required_dynamic_cast<GUIImageNode*>(particleSystemEditorTabController->screenNode->getNodeById("particleemitter_radial_colorend"))->setEffectColorMul(rpe->getColorEnd().getArray());
							} catch (Exception& exception) {
								Console::printLine("OnColorChangeAction::performAction(): An error occurred: " + string(exception.what()));
								particleSystemEditorTabController->showInfoPopUp("Warning", string(exception.what()));
							}
...
void ParticleSystemEditorTabController::setParticleSystemDetails(int particleSystemIdx) {
	...
	try {
		...
		if (particleSystem->getEmitter() == PrototypeParticleSystem_Emitter::POINT_PARTICLE_EMITTER) {
			...
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_point_colorstart"))->setEffectColorMul(ppse->getColorStart().getArray());
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_point_colorend"))->setEffectColorMul(ppse->getColorEnd().getArray());
		...
		if (particleSystem->getEmitter() == PrototypeParticleSystem_Emitter::BOUNDINGBOX_PARTICLE_EMITTER) {
			...
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_box_colorstart"))->setEffectColorMul(bbpe->getColorStart().getArray());
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_box_colorend"))->setEffectColorMul(bbpe->getColorEnd().getArray());
		...
		if (particleSystem->getEmitter() == PrototypeParticleSystem_Emitter::CIRCLE_PARTICLE_EMITTER) {
			...
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_circle_colorstart"))->setEffectColorMul(cpse->getColorStart().getArray());
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_circle_colorend"))->setEffectColorMul(cpse->getColorEnd().getArray());
		...
		if (particleSystem->getEmitter() == PrototypeParticleSystem_Emitter::CIRCLE_PARTICLE_EMITTER_PLANE_VELOCITY) {
			...
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_radial_colorstart"))->setEffectColorMul(rpse->getColorStart().getArray());
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_radial_colorend"))->setEffectColorMul(rpse->getColorEnd().getArray());
		...
		if (particleSystem->getEmitter() == PrototypeParticleSystem_Emitter::SPHERE_PARTICLE_EMITTER) {
			...
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_sphere_colorstart"))->setEffectColorMul(spse->getColorStart().getArray());
			required_dynamic_cast<GUIImageNode*>(screenNode->getNodeById("particleemitter_sphere_colorend"))->setEffectColorMul(spse->getColorEnd().getArray());
