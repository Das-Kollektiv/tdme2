...
Matrix4x4::Matrix4x4(const ::default_init_tag&)
...
Matrix4x4::Matrix4x4() 
	: Matrix4x4(*static_cast< ::default_init_tag* >(0))
{
	ctor();
}
...
Matrix4x4::Matrix4x4(float r0c0, float r1c0, float r2c0, float r3c0, float r0c1, float r1c1, float r2c1, float r3c1, float r0c2, float r1c2, float r2c2, float r3c2, float r0c3, float r1c3, float r2c3, float r3c3) 
	: Matrix4x4(*static_cast< ::default_init_tag* >(0))
{
	ctor(r0c0,r1c0,r2c0,r3c0,r0c1,r1c1,r2c1,r3c1,r0c2,r1c2,r2c2,r3c2,r0c3,r1c3,r2c3,r3c3);
}

void Matrix4x4::ctor()
{
	super::ctor();
	data = new floatArray(16);
	Arrays::fill(data, 0.0f);
	_data = new floatArray(16);
	tmpVector3 = new Vector3();
}

void Matrix4x4::ctor(floatArray* m)
{
	super::ctor();
	data = new floatArray(16);
...
void Matrix4x4::ctor(Matrix4x4* matrix)
{
	super::ctor();
	data = new floatArray(16);
...
void Matrix4x4::ctor(float r0c0, float r1c0, float r2c0, float r3c0, float r0c1, float r1c1, float r2c1, float r3c1, float r0c2, float r1c2, float r2c2, float r3c2, float r0c3, float r1c3, float r2c3, float r3c3)
{
	super::ctor();
	data = new floatArray(16);
	_data = new floatArray(16);
...
{
	return Math::abs((*data)[0] - (*m->data)[0]) < MathTools::EPSILON && Math::abs((*data)[1] - (*m->data)[1]) < MathTools::EPSILON && Math::abs((*data)[2] - (*m->data)[2]) < MathTools::EPSILON && Math::abs((*data)[3] - (*m->data)[3]) < MathTools::EPSILON && Math::abs((*data)[4] - (*m->data)[4]) < MathTools::EPSILON && Math::abs((*data)[5] - (*m->data)[5]) < MathTools::EPSILON && Math::abs((*data)[6] - (*m->data)[6]) < MathTools::EPSILON && Math::abs((*data)[7] - (*m->data)[7]) < MathTools::EPSILON && Math::abs((*data)[8] - (*m->data)[8]) < MathTools::EPSILON && Math::abs((*data)[9] - (*m->data)[9]) < MathTools::EPSILON && Math::abs((*data)[10] - (*m->data)[10]) < MathTools::EPSILON && Math::abs((*data)[11] - (*m->data)[11]) < MathTools::EPSILON && Math::abs((*data)[12] - (*m->data)[12]) < MathTools::EPSILON && Math::abs((*data)[13] - (*m->data)[13]) < MathTools::EPSILON && Math::abs((*data)[14] - (*m->data)[14]) < MathTools::EPSILON && Math::abs((*data)[15] - (*m->data)[15]) < MathTools::EPSILON;
}

floatArray* Matrix4x4::getArray()
{
	return data;
}
...
{
	clinit();
	return dest->set(((*m2->data)[0] * t) + ((1.0f - t) * (*m1->data)[0]), ((*m2->data)[1] * t) + ((1.0f - t) * (*m1->data)[1]), ((*m2->data)[2] * t) + ((1.0f - t) * (*m1->data)[2]), ((*m2->data)[3] * t) + ((1.0f - t) * (*m1->data)[3]), ((*m2->data)[4] * t) + ((1.0f - t) * (*m1->data)[4]), ((*m2->data)[5] * t) + ((1.0f - t) * (*m1->data)[5]), ((*m2->data)[6] * t) + ((1.0f - t) * (*m1->data)[6]), ((*m2->data)[7] * t) + ((1.0f - t) * (*m1->data)[7]), ((*m2->data)[8] * t) + ((1.0f - t) * (*m1->data)[8]), ((*m2->data)[9] * t) + ((1.0f - t) * (*m1->data)[9]), ((*m2->data)[10] * t) + ((1.0f - t) * (*m1->data)[10]), ((*m2->data)[11] * t) + ((1.0f - t) * (*m1->data)[11]), ((*m2->data)[12] * t) + ((1.0f - t) * (*m1->data)[12]), ((*m2->data)[13] * t) + ((1.0f - t) * (*m1->data)[13]), ((*m2->data)[14] * t) + ((1.0f - t) * (*m1->data)[14]), ((*m2->data)[15] * t) + ((1.0f - t) * (*m1->data)[15]));
}
...
java::lang::Class* Matrix4x4::class_()
{
    static ::java::lang::Class* c = ::class_(u"tdme.math.Matrix4x4", 19);
    return c;
}

bool Matrix4x4::equals(Object* obj)
{
	return super::equals(obj);
}

java::lang::Class* Matrix4x4::getClass0()
{
	return class_();
}
