...
PartitionOctTree_reset_4::PartitionOctTree_reset_4(PartitionOctTree *PartitionOctTree_this)
...
_ArrayList* PartitionOctTree_reset_4::instantiate()
{
...
java::lang::Class* PartitionOctTree_reset_4::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* PartitionOctTree_reset_4::getClass0()
{
	return class_();
}
