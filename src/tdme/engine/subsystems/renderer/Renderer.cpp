...
Renderer::Renderer()
{
	...
	LIGHTING_SPECULAR = 1;
	LIGHTING_PBR = 2;
	TEXTURETYPE_TEXTURE = -1;
	TEXTURETYPE_CUBEMAP_POSITIVE_X = -1;
	TEXTURETYPE_CUBEMAP_NEGATIVE_X = -1;
	TEXTURETYPE_CUBEMAP_POSITIVE_Y = -1;
	TEXTURETYPE_CUBEMAP_NEGATIVE_Y = -1;
	TEXTURETYPE_CUBEMAP_POSITIVE_Z = -1;
	TEXTURETYPE_CUBEMAP_NEGATIVE_Z = -1;
	viewPortX = 0;
	viewPortY = 0;
	viewPortWidth = 0;
	viewPortHeight = 0;
