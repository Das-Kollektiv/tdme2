 ...
 */
class tdme::engine::subsystems::lighting::LightingShaderPBRTreeImplementation: public LightingShaderPBRBaseImplementation
{
private:
...
public:
	// forbid class copy
	FORBID_CLASS_COPY(LightingShaderPBRTreeImplementation)

	/**
	 * Public constructor
	 * @param renderer renderer
	 */
	LightingShaderPBRTreeImplementation(Renderer* renderer);
