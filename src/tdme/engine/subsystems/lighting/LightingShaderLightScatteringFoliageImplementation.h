...
public:
	// forbid class copy
	FORBID_CLASS_COPY(LightingShaderLightScatteringFoliageImplementation)

	/**
	 * Public constructor
	 * @param rendererBackend renderer backend
	 */
	LightingShaderLightScatteringFoliageImplementation(RendererBackend* rendererBackend);
