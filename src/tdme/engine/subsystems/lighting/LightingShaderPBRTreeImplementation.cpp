...
bool LightingShaderPBRTreeImplementation::isSupported(RendererBackend* rendererBackend) {
	return rendererBackend->isPBRAvailable();
}

LightingShaderPBRTreeImplementation::LightingShaderPBRTreeImplementation(RendererBackend* rendererBackend): LightingShaderPBRBaseImplementation(rendererBackend)
{
}
...
void LightingShaderPBRTreeImplementation::updateShaderParameters(RendererBackend* rendererBackend, int contextIdx) {
