...
bool LightingShaderTerrainImplementation::isSupported(RendererBackend* rendererBackend) {
	return true;
}

LightingShaderTerrainImplementation::LightingShaderTerrainImplementation(RendererBackend* rendererBackend): LightingShaderBaseImplementation(rendererBackend)
{
}
...
void LightingShaderTerrainImplementation::updateMatrices(RendererBackend* rendererBackend, int contextIdx) {
...
void LightingShaderTerrainImplementation::updateShaderParameters(RendererBackend* rendererBackend, int contextIdx) {
}
