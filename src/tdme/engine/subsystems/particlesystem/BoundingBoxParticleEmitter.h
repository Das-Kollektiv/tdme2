...
protected:
	 ...
	 * @param color end 
	 */
	void ctor(int32_t count, int64_t lifeTime, int64_t lifeTimeRnd, float mass, float massRnd, OrientedBoundingBox* obb, Vector3* velocity, Vector3* velocityRnd, Color4* colorStart, Color4* colorEnd);
...
protected:
	BoundingBoxParticleEmitter(const ::default_init_tag&);
