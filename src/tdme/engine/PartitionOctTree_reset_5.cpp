...
PartitionOctTree_reset_5::PartitionOctTree_reset_5(PartitionOctTree *PartitionOctTree_this)
...
_ArrayList* PartitionOctTree_reset_5::instantiate()
{
...
java::lang::Class* PartitionOctTree_reset_5::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* PartitionOctTree_reset_5::getClass0()
{
	return class_();
}
