...
public:
	...
	enum RenderPass { RENDERPASS_NONE = 0, RENDERPASS_SKY = 1, RENDERPASS_NOFRUSTUMCULLING = 1, RENDERPASS_TERRAIN = 2, RENDERPASS_WATER = 4, RENDERPASS_STANDARD = 8, RENDERPASS_POST_POSTPROCESSING = 16 };
