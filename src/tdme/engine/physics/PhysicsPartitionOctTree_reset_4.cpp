...
PhysicsPartitionOctTree_reset_4::PhysicsPartitionOctTree_reset_4(PhysicsPartitionOctTree *PhysicsPartitionOctTree_this)
...
_ArrayList* PhysicsPartitionOctTree_reset_4::instantiate()
{
...
java::lang::Class* PhysicsPartitionOctTree_reset_4::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* PhysicsPartitionOctTree_reset_4::getClass0()
{
	return class_();
}
