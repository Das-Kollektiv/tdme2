...
public: /* protected */
	 ...
	 * @param value
	 */
	inline Vector6& fill(float value) {
		data.fill(value);
		return *this;
	}
	 ...
	 * @return this vector
	 */
	inline Vector6& set(const Vector6& vector6) {
	 ...
	 * @param value
	 */
	inline Vector6& setValue(int32_t idx, float value) {
		data[idx] = value;
		return *this;
	}
	 ...
	 * @param vector 3
	 */
	inline Vector6& setValue(int32_t startIdx, const Vector3& vector3) {
	 ...
	 * @param this vector 6
	 */
	inline Vector6& add(const Vector6& vector6) {
	 ...
	 * @param this vector 6
	 */
	inline Vector6& sub(const Vector6& vector6) {
		data[0] -= vector6.data[0];
		data[1] -= vector6.data[1];
		data[2] -= vector6.data[2];
		data[3] -= vector6.data[3];
	 ...
	 * @return data array
	 */
	inline array<float, 6>& getArray() const {
		return (array<float, 6>&)data;
	}
