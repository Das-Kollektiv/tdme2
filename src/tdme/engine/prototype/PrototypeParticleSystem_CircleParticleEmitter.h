 ...
 */
class tdme::engine::prototype::PrototypeParticleSystem_CircleParticleEmitter final
{
private:
	int count;
	int64_t lifeTime;
...
public:
	// forbid class copy
	FORBID_CLASS_COPY(PrototypeParticleSystem_CircleParticleEmitter)

	/**
	 * Public constructor
	 */
	PrototypeParticleSystem_CircleParticleEmitter();
