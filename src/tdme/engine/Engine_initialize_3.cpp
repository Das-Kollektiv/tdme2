...
Engine_initialize_3::Engine_initialize_3(Engine *Engine_this)
...
void Engine_initialize_3::onUpdateProjectionMatrix()
{
...
void Engine_initialize_3::onUpdateCameraMatrix()
{
	if (Engine::lightingShader != nullptr)
		Engine::lightingShader->updateMatrices(this);
...
void Engine_initialize_3::onUpdateModelViewMatrix()
{
	if (Engine::lightingShader != nullptr)
		Engine::lightingShader->updateMatrices(this);
...
void Engine_initialize_3::onBindTexture(int32_t textureId)
{
	if (Engine::lightingShader != nullptr)
...
void Engine_initialize_3::onUpdateTextureMatrix()
{
}

void Engine_initialize_3::onUpdateEffect()
{
	if (Engine::lightingShader != nullptr)
...
void Engine_initialize_3::onUpdateLight(int32_t lightId)
{
	if (Engine::lightingShader != nullptr)
...
void Engine_initialize_3::onUpdateMaterial()
{
	if (Engine::lightingShader != nullptr)
...
java::lang::Class* Engine_initialize_3::class_()
{
    static ::java::lang::Class* c = ::class_(u"", 0);
    return c;
}

java::lang::Class* Engine_initialize_3::getClass0()
{
	return class_();
}
