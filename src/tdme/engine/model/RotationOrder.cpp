...
RotationOrder::RotationOrder(::java::lang::String* name, int ordinal, Vector3* axis0, Vector3* axis1, Vector3* axis2, int32_t axis0VectorIndex, int32_t axis1VectorIndex, int32_t axis2VectorIndex, int32_t axisXIndex, int32_t axisYIndex, int32_t axisZIndex) 
...
RotationOrder* tdme::engine::model::RotationOrder::XYZ = new RotationOrder(u"XYZ"_j, 0, new Vector3(1.0f, 0.0f, 0.0f), new Vector3(0.0f, 1.0f, 0.0f), new Vector3(0.0f, 0.0f, 1.0f), 0, 1, 2, 0, 1, 2);
RotationOrder* tdme::engine::model::RotationOrder::YZX = new RotationOrder(u"YZX"_j, 1, new Vector3(0.0f, 1.0f, 0.0f), new Vector3(0.0f, 0.0f, 1.0f), new Vector3(1.0f, 0.0f, 0.0f), 1, 2, 0, 2, 0, 1);
RotationOrder* tdme::engine::model::RotationOrder::ZYX = new RotationOrder(u"ZYX"_j, 2, new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, 1.0f, 0.0f), new Vector3(1.0f, 0.0f, 0.0f), 2, 1, 0, 2, 1, 0);
void RotationOrder::ctor(::java::lang::String* name, int ordinal, Vector3* axis0, Vector3* axis1, Vector3* axis2, int32_t axis0VectorIndex, int32_t axis1VectorIndex, int32_t axis2VectorIndex, int32_t axisXIndex, int32_t axisYIndex, int32_t axisZIndex)
{
...
RotationOrder* RotationOrder::valueOf(String* a0)
{
	if (XYZ->toString()->equals(a0))
		return XYZ;
	if (YZX->toString()->equals(a0))
		return YZX;
