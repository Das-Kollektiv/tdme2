...
void EngineTest::initialize()
{
	...
	try {
		...
		engine->addEntity(new PointsParticleSystemEntity(L"circle", false, new CircleParticleEmitter(3000, 50, 50, new Vector3(1.0f, 0.0f, 0.0f), new Vector3(0.0f, 0.0f, 1.0f), new Vector3(0.0f, 0.0f, 0.0f), 0.4f, 0.0f, 0.0f, new Vector3(0.0f, 0.2f, 0.0f), new Vector3(0.0f, 0.2f, 0.0f), new Color4(1.0f, 1.0f, 1.0f, 0.3f), new Color4(1.0f, 1.0f, 1.0f, 0.3f)), 1000, true));
		engine->getEntity(L"circle")->setEnabled(true);
		engine->addEntity(new PointsParticleSystemEntity(L"water", true, new SphereParticleEmitter(4000, 1000, 0, 0.1f, 0.0f, new Sphere(Vector3(-1.0f, 1.0f, 0.0f), 0.05f), new Vector3(-4.0f, 0.0f, 1.0f), new Vector3(-1.0f, 0.0f, 0.0f), new Color4(0.8f, 0.8f, 1.0f, 0.25f), new Color4(0.8f, 0.8f, 1.0f, 0.25f)), 4000, true));
		engine->getEntity(L"water")->setEnabled(true);
		engine->addEntity(new PointsParticleSystemEntity(L"snow", false, new BoundingBoxParticleEmitter(15, 15000, 1000, 0, 0, new OrientedBoundingBox(Vector3(0.0f, 4.0f, 0.0f), Vector3(1.0f, 0.0f, 0.0f), Vector3(0.0f, 1.0f, 0.0f), Vector3(0.0f, 0.0f, 1.0f), Vector3(4.0f, 0.0f, 4.0f)), new Vector3(0.0f, -0.5f, 0.0f), new Vector3(0.0f, -0.1f, 0.0f), new Color4(0.8f, 0.8f, 1.0f, 0.5f), new Color4(0.8f, 0.8f, 1.0f, 0.5f)), 1024, true));
		engine->getEntity(L"snow")->setEnabled(true);
		engine->addEntity(new PointsParticleSystemEntity(L"firebase", false, new SphereParticleEmitter(2048, 1024, 2048, 0, 0, new Sphere(Vector3(2.5f, 0.2f, 0.0f), 0.2f), new Vector3(0.0f, 0.1f, 0.0f), new Vector3(0.0f, 0.1f, 0.0f), new Color4(0.0f, 0.0f, 0.0f, 0.5f), new Color4(0.4f, 0.0f, 0.0f, 0.5f)), 2048, true));
		engine->getEntity(L"firebase")->setEnabled(true);
		engine->addEntity(new PointsParticleSystemEntity(L"firetop", false, new SphereParticleEmitter(2048, 1024, 2048, 0, 0, new Sphere(Vector3(2.5f, 0.7f, 0.0f), 0.1f), new Vector3(0.0f, 0.06f, 0.0f), new Vector3(0.0f, 0.12f, 0.0f), new Color4(0.75f, 0.0f, 0.0f, 0.5f), new Color4(1.0f, 1.0f, 0.0f, 0.5f)), 2048, true));
		engine->getEntity(L"firetop")->setEnabled(true);
		engine->addEntity(new PointsParticleSystemEntity(L"firesmoke", false, new SphereParticleEmitter(2048, 1024, 2048, 0, 0, new Sphere(Vector3(2.5f, 0.7f, 0.0f), 0.1f), new Vector3(0.0f, 0.2f, 0.0f), new Vector3(0.0f, 0.4f, 0.0f), new Color4(0.8f, 0.8f, 0.8f, 0.1f), new Color4(0.8f, 0.8f, 0.8f, 0.1f)), 2048, true));
