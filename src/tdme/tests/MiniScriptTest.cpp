...
void MiniScriptTest::initializeNative() {
	setNative(true);
	setHash("0eb474e59d563e9a23b22672d1efca3087726fd90e82d3028f03a992a799963f");
	setNativeScripts(
		{
			{
			...
			},
			{
				...
				.statements = {
					...
					},
					{
						.line = 161,
						.statementIdx = 150,
						.statement = "console.log(\"array pushed 8, 9, 10: \")",
						.gotoStatementIdx = -1
					},
					{
						.line = 162,
					...
					},
					{
						.line = 164,
						.statementIdx = 153,
						.statement = "console.log(\"array iteration: \")",
						.gotoStatementIdx = -1
					},
					{
						.line = 165,
					...
					},
					{
						.line = 170,
						.statementIdx = 159,
						.statement = "console.log(\"array set at index 20 = 11: \")",
						.gotoStatementIdx = -1
					},
					{
						.line = 171,
						.statementIdx = 160,
						.statement = "setVariable(\"$array\", array.set($array, 20, 11))",
						.gotoStatementIdx = -1
					},
					{
						.line = 172,
					...
					},
					{
						.line = 173,
						.statementIdx = 162,
						.statement = "console.log(\"array remove @ 20: \")",
						.gotoStatementIdx = -1
					},
					{
						.line = 174,
						.statementIdx = 163,
						.statement = "setVariable(\"$array\", array.remove($array, 20))",
						.gotoStatementIdx = -1
					},
					{
						.line = 175,
...
void MiniScriptTest::on_nothing(int miniScriptGotoStatementIdx) {
	...
	if (miniScriptGotoStatementIdx == 101) goto miniscript_statement_101; else
	if (miniScriptGotoStatementIdx == 103) goto miniscript_statement_103; else
	if (miniScriptGotoStatementIdx == 108) goto miniscript_statement_108; else
	if (miniScriptGotoStatementIdx == 110) goto miniscript_statement_110; else
	if (miniScriptGotoStatementIdx == 112) goto miniscript_statement_112; else
	if (miniScriptGotoStatementIdx == 118) goto miniscript_statement_118; else
	if (miniScriptGotoStatementIdx == 120) goto miniscript_statement_120; else
	...
	if (miniScriptGotoStatementIdx == 138) goto miniscript_statement_138; else
	if (miniScriptGotoStatementIdx == 156) goto miniscript_statement_156; else
	if (miniScriptGotoStatementIdx == 159) goto miniscript_statement_159; else
	...
	// console.log("array pushed 8, 9, 10: ")
	{
		...
		array<ScriptVariable, 1> argumentValues;
		array<ScriptVariable, 1>& argumentValuesD0 = argumentValues;
		argumentValues[0].setValue(string("array pushed 8, 9, 10: "));
		// method code: console.log
		for (auto& argumentValue: argumentValues) {
			Console::print(argumentValue.getValueString());
		}
	...
	// console.log("array iteration: ")
	{
		...
		array<ScriptVariable, 1> argumentValues;
		array<ScriptVariable, 1>& argumentValuesD0 = argumentValues;
		argumentValues[0].setValue(string("array iteration: "));
		// method code: console.log
		for (auto& argumentValue: argumentValues) {
			Console::print(argumentValue.getValueString());
		}
	...
	// console.log("array set at index 20 = 11: ")
	{
		...
		array<ScriptVariable, 1> argumentValues;
		array<ScriptVariable, 1>& argumentValuesD0 = argumentValues;
		argumentValues[0].setValue(string("array set at index 20 = 11: "));
		// method code: console.log
		for (auto& argumentValue: argumentValues) {
			Console::print(argumentValue.getValueString());
		}
	...
	// Statement: 160
	// setVariable("$array", array.set($array, 20, 11))
	{
		...
		array<ScriptVariable, 2>& argumentValuesD0 = argumentValues;
		argumentValues[0].setValue(string("$array"));
		// argumentValues[1] --> returnValue of array.set($array, 20, 11)
		// depth = 1 / argument index = 1: array.set($array, 20, 11)
		{
			// required method code arguments
			ScriptVariable& returnValue = argumentValuesD0[1];
			array<ScriptVariable, 3> argumentValues;
			array<ScriptVariable, 3>& argumentValuesD1AIDX1 = argumentValues;
			// argumentValues[0] --> returnValue of getVariable("$array")
			argumentValues[1].setValue(static_cast<int64_t>(20));
			argumentValues[2].setValue(static_cast<int64_t>(11));
			// depth = 2 / argument index = 0: getVariable("$array")
			{
				// required method code arguments
				ScriptVariable& returnValue = argumentValuesD1AIDX1[0];
			...
			// method code: array.set
			int64_t index;
			if ((argumentValues.size() <= 2 || argumentValues[0].getType() != ScriptVariableType::TYPE_ARRAY) ||
				MiniScript::getIntegerValue(argumentValues, 1, index, false) == false) {
				Console::println("ScriptMethodArraySet::executeMethod(): " + string("array.set") + "(): parameter type mismatch @ argument 0: array expected, @argument 1: integer expected");
			} else {
				returnValue = argumentValues[0];
	...
	// console.log("array remove @ 20: ")
	{
		...
		array<ScriptVariable, 1> argumentValues;
		array<ScriptVariable, 1>& argumentValuesD0 = argumentValues;
		argumentValues[0].setValue(string("array remove @ 20: "));
		// method code: console.log
		for (auto& argumentValue: argumentValues) {
			Console::print(argumentValue.getValueString());
		}
	...
	// Statement: 163
	// setVariable("$array", array.remove($array, 20))
	{
		...
		array<ScriptVariable, 2>& argumentValuesD0 = argumentValues;
		argumentValues[0].setValue(string("$array"));
		// argumentValues[1] --> returnValue of array.remove($array, 20)
		// depth = 1 / argument index = 1: array.remove($array, 20)
		{
			// required method code arguments
			ScriptVariable& returnValue = argumentValuesD0[1];
			array<ScriptVariable, 2> argumentValues;
			...
			// method code: array.remove
			int64_t index;
			if ((argumentValues.size() < 2 || argumentValues[0].getType() != ScriptVariableType::TYPE_ARRAY) ||
				MiniScript::getIntegerValue(argumentValues, 1, index, false) == false) {
				Console::println("ScriptMethodArraySet::executeMethod(): " + string("array.remove") + "(): parameter type mismatch @ argument 0: array expected, @argument 1: integer expected");
			} else {
