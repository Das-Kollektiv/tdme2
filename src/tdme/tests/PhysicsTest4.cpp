...
int PhysicsTest4::main(int argc, char** argv)
{
	auto physicsTest4 = new PhysicsTest4();
	return physicsTest4->run(argc, argv, "PhysicsTest4", physicsTest4);
}
...
void PhysicsTest4::initialize()
{
	...
	world->addRigidBody("box", RIGID_TYPEID_STANDARD, true, entity->getTransform(), 0.0f, 1.0f, 100.0f, Vector3(1.0f, 1.0f, 1.0f), {box});
