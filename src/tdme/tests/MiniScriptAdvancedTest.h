...
protected:
	...
	/**
	 * Miniscript transpilation for a statement array access statement for method 'on_nothing', statement index 7, argument index 0, array access statement index 0 and depth 3
	 * @param statement statement
	 * @return array index
	 */
	ScriptVariable on_nothing_array_access_statement_s_7_0_0_3(const ScriptStatement& statement);

	/**
	 * Miniscript transpilation for a statement array/map/set initializer for method 'on_nothing', statement index 3, argument index 0
	 * @param statement statement
	 * @return array index
	 */
	ScriptVariable on_nothing_initializer_s_3_0(const ScriptStatement& statement);

	/**
	 * Miniscript transpilation for a statement array/map/set initializer for method 'on_nothing', statement index 13, argument index 0
	 * @param statement statement
	 * @return array index
	 */
	ScriptVariable on_nothing_initializer_s_13_0(const ScriptStatement& statement);

	/**
	 * Miniscript transpilation for a statement array/map/set initializer for method 'on_nothing', statement index 18, argument index 0
	 * @param statement statement
	 * @return array index
	 */
	ScriptVariable on_nothing_initializer_s_18_0(const ScriptStatement& statement);
