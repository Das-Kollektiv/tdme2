...
layout(std430,binding=3) buffer InSkinningVertexJointIdxs { int inSkinningVertexJointIdxs[][4]; };
layout(std430,binding=4) buffer InSkinningVertexJointWeights { float inSkinningVertexJointWeights[][4]; };
