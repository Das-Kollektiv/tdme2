...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Create string                                                                                    |
| <sub>static string($string: String): String</sub>                                                |
...
| Concatenate strings                                                                              |
| <sub>static string.concatenate(...): String</sub>                                                |
...
| <sub>static string.equalsIgnoreCase($string1: String, $string2: String): Boolean</sub>           |
...
| Pad string left                                                                                  |
| <sub>static string.padLeft($src: String, $by: String, $toSize: Integer): String</sub>            |
| Pad string right                                                                                 |
| <sub>static string.padRight($src: String, $by: String, $toSize: Integer): String</sub>           |
| RegEx match                                                                                      |
...
| <sub>static string.space([, $spaces: Integer]): String</sub>                                     |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Create vector2                                                                                   |
| <sub>static vec2($x: Float, $y: Float): Vector2</sub>                                            |
| Compute vector2 dot product                                                                      |
| <sub>static vec2.computeDotProduct($a: Vector2, $b: Vector2): Float</sub>                        |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Create vector3                                                                                   |
| <sub>static vec3($x: Float, $y: Float, $z: Float): Vector3</sub>                                 |
| Compute angle between two vector3                                                                |
| <sub>static vec3.computeAngle($a: Vector3, $b: Vector3, $n: Vector3): Float</sub>                |
| Compute vector3 cross product                                                                    |
| <sub>static vec3.computeCrossProduct($a: Vector3, $b: Vector3): Vector3</sub>                    |
| Compute vector3 dot product                                                                      |
| <sub>static vec3.computeDotProduct($a: Vector3, $b: Vector3): Float</sub>                        |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Create vector4                                                                                   |
| <sub>static vec4($x: Float, $y: Float, $z: Float, $w: Float): Vector4</sub>                      |
| Compute vector4 dot product                                                                      |
| <sub>static vec4.computeDotProduct($a: Vector4, $b: Vector4): Float</sub>                        |
...
| <sub>static quaternion.identity(): Quaternion</sub>                                              |
...
| <sub>static quaternion.rotate($axis: Vector3, $angle: Float): Quaternion</sub>                   |
...
| <sub>static mat3.identity(): Matrix3x3</sub>                                                     |
| Multiply 3x3 matrix with 3x3 matrix or vector2                                                   |
| <sub>mat3.multiply(, ...): Mixed</sub>                                                           |
| Create rotation 3x3 matrix                                                                       |
| <sub>static mat3.rotate($angle: Float): Matrix3x3</sub>                                          |
| Create 3x3 matrix which rotates around point                                                     |
| <sub>static mat3.rotateAroundPoint($point: Vector2, $angle: Float): Matrix3x3</sub>              |
| Create 3x3 matrix which rotates around texture center                                            |
| <sub>static mat3.rotateAroundTextureCenter($angle: Float): Matrix3x3</sub>                       |
| Create scale 3x3 matrix                                                                          |
| <sub>static mat3.scale(...): Matrix3x3</sub>                                                     |
| Create translation 3x3 matrix                                                                    |
| <sub>static mat3.translate($translation: Vector2): Matrix3x3</sub>                               |
...
| <sub>static mat4.identity(): Matrix4x4</sub>                                                     |
...
| <sub>static mat4.rotate($axis: Vector3, $angle: Float): Matrix4x4</sub>                          |
| Create scale 4x4 matrix                                                                          |
| <sub>static mat4.scale(...): Matrix4x4</sub>                                                     |
| Create translation 4x4 matrix                                                                    |
| <sub>static mat4.translate($translation: Vector3): Matrix4x4</sub>                               |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Create transform                                                                                 |
| <sub>static transform([, $translation: Vector3[, $scale: Vector3[, $rotationZ: Float[, $rotationY: Float[, $rotationX: Float]]]]]): Transform</sub>|
| X axis as vector3                                                                                |
| <sub>static transform.AXIS_X(): Vector3</sub>                                                    |
| Y axis as vector3                                                                                |
| <sub>static transform.AXIS_Y(): Vector3</sub>                                                    |
| Z axis as vector3                                                                                |
| <sub>static transform.AXIS_Z(): Vector3</sub>                                                    |
...
| <sub>static transform.fromMatrix($transformMatrix: Matrix4x4): Transform</sub>                   |
| Interpolate rotation                                                                             |
| <sub>static transform.interpolateRotation($currentAngle: Float, $targetAngle: Float, $timePassedSeconds: Float, $degreesPerSeconds: Float, =$interpolatedAngle: Float): Boolean</sub>|
