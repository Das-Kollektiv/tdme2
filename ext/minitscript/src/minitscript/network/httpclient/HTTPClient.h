 ...
 */
class minitscript::network::httpclient::HTTPClient {
...
public:
	MINITSCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_GET;
	MINITSCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_HEAD;
	MINITSCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_POST;
	MINITSCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_PUT;
	MINITSCRIPT_STATIC_DLL_IMPEXT static const string HTTP_METHOD_DELETE;
	 ...
	 * @throws minitscript::network::httpclient::_HTTPClientException
	 * @throws minitscript::os::network::_NetworkException
	 */
	void execute();
