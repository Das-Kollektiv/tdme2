...
#include <minitscript/os/filesystem/fwd-minitscript.h>
 ...
 */
class minitscript::os::filesystem::FileSystem final
{
...
public:
	 ...
	 * @author Andreas Drewke
	 */
	class FileSystemException: public ::minitscript::utilities::ExceptionBase
	{
	public:
		/**
