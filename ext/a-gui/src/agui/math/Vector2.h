...
public:
	 ...
	 * Operator + scalar
	 * @param scalar scalar
	 * @returns new vector2 (this + scalar)
	 */
	 ...
	 * Operator + vector2
	 * @param vector2 vector2
	 * @returns new vector2 (this + vector2)
	 */
