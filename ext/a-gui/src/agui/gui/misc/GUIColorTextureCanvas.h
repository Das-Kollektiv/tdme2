 ...
 */
class agui::gui::misc::GUIColorTextureCanvas final
{
public:
	// forbid class copy
	FORBID_CLASS_COPY(GUIColorTextureCanvas)

	/**
	 * Public constructor
	 * @param texture texture
	 */
	inline GUIColorTextureCanvas(GUITexture* texture) {
	 ...
	 * Destructor
	 */
	inline virtual ~GUIColorTextureCanvas() {
