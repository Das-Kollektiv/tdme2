...
GUIMinitScript::GUIMinitScript(GUIScreenNode* screenNode): MinitScript(), screenNode(screenNode) {
}
...
const string GUIMinitScript::getBaseClass() {
	return "agui::gui::scripting::GUIMinitScript";
}

const vector<string> GUIMinitScript::getTranspilationUnits() {
	auto transpilationUnits = MinitScript::getTranspilationUnits();
...
void GUIMinitScript::registerStateMachineStates() {
	MinitScript::registerStateMachineStates();
}
...
void GUIMinitScript::registerMethods() {
	...
	// input
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_LEFT));
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_RIGHT));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_UP));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_DOWN));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_POS1));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_END));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_PAGE_UP));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_PAGE_DOWN));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_BACKSPACE));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_DELETE));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_SPACE));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_RETURN));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_ESCAPE));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F1));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F2));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F3));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F4));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F5));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F6));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F7));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F8));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F9));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F10));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F11));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIKeyboardEvent::KEYCODE_F12));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				if (minitScript->getIntegerValue(arguments, 0, keyCode) == true) {
					returnValue.setValue(minitScript->keyboardKeys.find(keyCode) != minitScript->keyboardKeys.end());
				} else {
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				if (minitScript->getStringValue(arguments, 0, charAsString) == true) {
					...
					returnValue.setValue(minitScript->keyboardChars.find(keyChar) != minitScript->keyboardChars.end());
				} else {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->keyboardTypedChars);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->keyboardControlDown == true);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->keyboardAltDown == true);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->keyboardShiftDown == true);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	// mouse input
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIMouseEvent::MOUSEEVENT_BUTTON_LEFT - 1));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIMouseEvent::MOUSEEVENT_BUTTON_MIDDLE - 1));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(GUIMouseEvent::MOUSEEVENT_BUTTON_RIGHT - 1));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				if (minitScript->getIntegerValue(arguments, 0, button) == true) {
					returnValue.setValue(button >= 0 && button <= 3?minitScript->mouseDown[button]:false);
				} else {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				int64_t button;
				if (minitScript->getIntegerValue(arguments, 0, button) == true) {
					returnValue.setValue(button >= 0 && button <= 3?minitScript->mouseUp[button]:false);
				} else {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				int64_t button;
				if (minitScript->getIntegerValue(arguments, 0, button) == true) {
					returnValue.setValue(button >= 0 && button <= 3?minitScript->mouseDragging[button]:false);
				} else {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->mouseMoved);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(minitScript->mouseX));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(minitScript->mouseXUnscaled));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(minitScript->mouseY));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(static_cast<int64_t>(minitScript->mouseYUnscaled));
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->mouseWheelX);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->mouseWheelY);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				returnValue.setValue(minitScript->mouseWheelZ);
			}
			const vector<string>& getContextFunctions() {
				return CONTEXTFUNCTION_GUI;
			}
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				string fileName;
				if (arguments.size() > 3 ||
					MinitScript::getStringValue(arguments, 0, fileName, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
					...
					try {
						...
						minitScript->nextScreenNode = unique_ptr<GUIScreenNode>(
							GUIParser::parse(
								...
								arguments.size() == 3?MinitScript::Variable::createNonReferenceVariable(&arguments[2]):MinitScript::Variable()
							)
						);
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				string nodeId;
				if (MinitScript::getStringValue(arguments, 0, nodeId, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				string value;
				if (MinitScript::getStringValue(arguments, 0, nodeId, false) == false ||
					MinitScript::getStringValue(arguments, 1, value, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
					auto node = minitScript->screenNode->getNodeById(nodeId);
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				string textNodeId;
				if (MinitScript::getStringValue(arguments, 0, textNodeId, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				string text;
				if (MinitScript::getStringValue(arguments, 0, textNodeId, false) == false ||
					MinitScript::getStringValue(arguments, 1, text, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
					auto textNode = dynamic_cast<GUITextNode*>(minitScript->screenNode->getNodeById(textNodeId));
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				string condition;
				if (MinitScript::getStringValue(arguments, 0, elementNodeId, false) == false ||
					MinitScript::getStringValue(arguments, 1, condition, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				string imageNodeId;
				if (MinitScript::getStringValue(arguments, 0, imageNodeId, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				string source;
				if (MinitScript::getStringValue(arguments, 0, imageNodeId, false) == false ||
					MinitScript::getStringValue(arguments, 1, source, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
					auto imageNode = dynamic_cast<GUIImageNode*>(minitScript->screenNode->getNodeById(imageNodeId));
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				string videoNodeId;
				if (MinitScript::getStringValue(arguments, 0, videoNodeId, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				string parentNodeId;
				if (MinitScript::getStringValue(arguments, 0, parentNodeId, false) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
	...
	}
	{
		...
		public:
			...
			void executeMethod(span<Variable>& arguments, Variable& returnValue, const SubStatement& subStatement) override {
				...
				if (MinitScript::getStringValue(arguments, 0, parentNodeId, false) == false ||
					MinitScript::getStringValue(arguments, 1, xml, false) == false ||
					MinitScript::getBooleanValue(arguments, 2, resetScrollOffsets, true) == false) {
					Console::printLine(getMethodName() + "(): " + minitScript->getSubStatementInformation(subStatement) + ": argument mismatch: expected arguments: " + minitScript->getArgumentsInformation(getMethodName()));
					minitScript->startErrorScript();
				} else {
					auto parentNode = dynamic_cast<GUIParentNode*>(minitScript->screenNode->getNodeById(parentNodeId));
