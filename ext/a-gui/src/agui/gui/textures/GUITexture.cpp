...
#include <agui/gui/fileio/BC7TextureReader.h>
...
ByteBuffer GUITexture::getRGBTextureData(TextureFormat format, const ByteBuffer& textureData) {
...
ByteBuffer GUITexture::getBC7TextureData() {
...
void GUITexture::setTextureData(TextureFormat format, const ByteBuffer& textureData) {
...
ByteBuffer GUITexture::generateMipMap(int textureWidth, int textureHeight, int bytesPerPixel, const ByteBuffer& textureTextureData) {
...
const vector<GUITexture::MipMapTexture>& GUITexture::getMipMapTextures(bool bc7Encoded) {
