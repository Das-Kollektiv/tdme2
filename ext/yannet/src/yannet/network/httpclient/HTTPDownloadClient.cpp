...
#include <yannet/utilities/Character.h>
#include <yannet/utilities/Console.h>
#include <yannet/utilities/Exception.h>
#include <yannet/utilities/Integer.h>
#include <yannet/utilities/StringTokenizer.h>
#include <yannet/utilities/StringTools.h>
...
using yannet::utilities::Character;
using yannet::utilities::Console;
using yannet::utilities::Exception;
using yannet::utilities::Integer;
using yannet::utilities::StringTokenizer;
using yannet::utilities::StringTools;
...
const string HTTPDownloadClient::createHTTPRequestHeaders(const string& hostName, const string& relativeUrl) {
	...
	auto request =
		...
		string("User-Agent: yannet-httpdownloadclient\r\n") +
